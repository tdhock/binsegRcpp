...
max_segs_interface <- function(N) {
    .Call('_binsegRcpp_max_segs_interface', PACKAGE = 'binsegRcpp', N)
}

#' Efficient log-linear cumulative median.
cum_median_interface <- function(data_vec, weight_vec) {
    .Call('_binsegRcpp_cum_median_interface', PACKAGE = 'binsegRcpp', data_vec, weight_vec)
}
...
depth_first_interface <- function(n_data, min_segment_length) {
    .Call('_binsegRcpp_depth_first_interface', PACKAGE = 'binsegRcpp', n_data, min_segment_length)
}
...
get_distribution_info <- function() {
    .Call('_binsegRcpp_get_distribution_info', PACKAGE = 'binsegRcpp')
}
...
binseg_interface <- function(data_vec, weight_vec, max_segments, min_segment_length, distribution_str, container_str, is_validation_vec, position_vec) {
    .Call('_binsegRcpp_binseg_interface', PACKAGE = 'binsegRcpp', data_vec, weight_vec, max_segments, min_segment_length, distribution_str, container_str, is_validation_vec, position_vec)
}
