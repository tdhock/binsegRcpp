#define ERROR_DEPTH_FIRST_N_DATA_MUST_BE_AT_LEAST_MIN_SEGMENT_LENGTH 1
#define ERROR_DEPTH_FIRST_MIN_SEGMENT_LENGTH_MUST_BE_POSITIVE 2
...
public:
  ...
  int depth_first(int *out_splits_, int *out_depth_);
