...
#define ERROR_BEST_SPLITS_N_SEGMENTS_TOO_LARGE 3

class Splitter {
public:
  int n_data, min_segment_length, n_segments, out_index;
  int *out_splits, *out_depth;
  Splitter(int n_data_, int min_segment_length_, int n_segments_);
