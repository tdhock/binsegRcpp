...
Rcpp::List rcpp_binseg_normal_cost(const Rcpp::NumericVector data_vec, int kmax);
RcppExport SEXP _binsegRcpp_rcpp_binseg_normal_cost(SEXP data_vecSEXP, SEXP kmaxSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::NumericVector >::type data_vec(data_vecSEXP);
    Rcpp::traits::input_parameter< int >::type kmax(kmaxSEXP);
    rcpp_result_gen = Rcpp::wrap(rcpp_binseg_normal_cost(data_vec, kmax));
    return rcpp_result_gen;
END_RCPP
}
